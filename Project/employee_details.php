...
<nav class="navbar navbar-inverse">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">View details<span class="caret"></span></a>
        ...
        <li class="active"><a href="employee_details.php"><span class="glyphicon glyphicon glyphicon-list-alt"></span> Employee List</a></li>
    ...
    <div class="container-fluid">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <p class="text-center"> Employee Details </p>
            </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                            ...
                            <?php
                                ...
                                echo  '<td><a class="btn btn-warning" href="remove-employee.php?username='.$row['username'].'"><span class="glyphicon glyphicon-trash"></span></a>
                                        </td> </tr>';
...
<?php
        ...
        if(isset($_GET['error'])){
          ...
          if(strcmp($msg,"No such employee exists.")==0||strcmp($msg,"Employee Deleted successfully.")==0){
            echo "<script>
