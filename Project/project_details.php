...
<nav class="navbar navbar-inverse">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">View details<span class="caret"></span></a>
        ...
        <li class="active"><a href="project_details.php"><span class="glyphicon glyphicon glyphicon-list-alt"></span> Project Details</a></li>
        </ul>    </ul>
    ...
    <div class="container-fluid">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <p class="text-center"> Project Details </p>
            </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                            ...
                            <?php
                                ...
                                {
                                echo "<tr><td>".$row['prj_name']."</td>";
                                echo "<td>".$row['prj_desc']."</td>";
                                echo "<td>".$row['prj_manager']."</td>";
                                echo "<td>".$row['prj_duration']."</td></tr>";
