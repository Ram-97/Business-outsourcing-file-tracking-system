<?php
   include('session.php');
   $sql=mysqli_query($db,"select prj_name  from project");
?>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Add Members<span class="caret"></span></a>
        <ul class="dropdown-menu">
         <li class="active"><a href="addemployee.php"><span class="glyphicon glyphicon-user"></span> Add Employee</a></li>
...
<div class="panel panel-primary">
    <div class="panel-heading"><h5 class="text-center">ADD EMPLOYEE</h5>
    </div>
...
<br/>
            <input type="submit" value="Add Employee" id="Request" class="btn btn-success center-block"/>
<br/>
        </form>
        </div>
</div>
...
<?php
        ...
        if(isset($_GET['error'])){
          ...
          if(strcmp($msg,"Employee Added successfully.")==0){
            echo "<script>
